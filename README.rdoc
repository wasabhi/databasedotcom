...
To contribute, all pull requests with code changes require unit tests. To setup the project locally and be able to run tests do the following:

1. Clone the databasedotcom project
2. Install rspec gem
3. Install webmock gem
